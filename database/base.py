...
engine = create_engine('sqlite:///customers', echo=False, connect_args={'check_same_thread': False})
...
class User(Base):
    ...
    created_on_str = Column(Unicode(128), default=created_on_datetime.strftime('%Y년 %m월 %d일 %H시 %M분'.encode('unicode-escape').decode()))
